...
suspend fun Spotify.getTopTracks(artistId: String) = getAndParse<TopTracksList>("artists/$artistId/top-tracks?country=US").tracks // TODO make country a parameter
